...
export const QuestionsTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6 text-slate-200">
      ...
      {/* Filters Bar (Subject, Exam Category, Dynamic Year Dropdown & Search) */}
      <div className="bg-[#0f172a]/95 border border-[#1e293b] rounded-2xl p-3.5 sm:p-4 shadow-lg flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 flex-1 flex-wrap">
          ...
          {/* Subject Dropdown - Only the subject name, no year */}
          <div className="relative">
            ...
            >
              ...
              <option value="LoCT 1011">Critical Thinking & Logic</option>
              <option value="Math 1011">Mathematics for Natural Science</option>
              <option value="Psyc 1011">Psychology and Life Skills</option>
              <option value="GeES 1011">Geography of Ethiopia & the Horn</option>
              <option value="Phys 1011">General Physics</option>
              <option value="FLEn 1011">Communicative English 1</option>
              <option value="Econ 1011">Economics for Social</option>
            </select>
